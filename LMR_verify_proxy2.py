...
#import LMR_verify_proxy2_config as Cfg
...
def recon_proxy_eval_stats(sites_eval,mode,proxy_dict,Xrecon,recondir,verif_period):
#==========================================================================================
# 
# 
#   Input : 
...
def main():
    ...
    for iter in MCiters:
        ...
        out_dict = recon_proxy_eval_stats(verif_proxies,'verif',proxy_dict,Xrecon,workdir,verif_period)
        ...
        out_dict = recon_proxy_eval_stats(assim_proxies,'assim',proxy_dict,Xrecon,workdir,verif_period)
