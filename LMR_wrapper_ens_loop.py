...
# unique to this version of the code: loop over ensemble size to assess convergence in that parameter
for Nens in [10,30,50,75,500]:

    # rest the ensemble size
    a.Nens             = Nens

    # Define main experiment output directory
    expdir = datadir_output + '/' + nexp + '_Nens_'+str(Nens)
    ...
    for iter in MCiters:
        ...
        arc_dir = archive_dir + '/' + nexp + '_Nens_'+str(Nens)
