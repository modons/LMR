...
# Current choices: 'Arctic','NE Atlantic','Europe','Asia','North America','South America','Australasia','Antarctica','Greenland'
# ------------------------------------------------------------------------------------------------------------------------------
regions_to_plot = ['Arctic', 'NE Atlantic', 'Europe', 'Asia', 'North America', 'South America', 'Australasia', 'Antarctica']
#regions_to_plot = ['Arctic', 'NE Atlantic', 'Greenland', 'Europe', 'Asia', 'North America']
...
plt.subplots_adjust(left=0.1, bottom=0.05, right=0.95, top=0.97, wspace=0.4, hspace=0.35)
